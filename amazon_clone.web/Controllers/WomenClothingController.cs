...
{
    public class WomenClothingController : Controller
    {
        private readonly IUnitOfWork _unitOfWork;

        public WomenClothingController(IUnitOfWork unitOfWork)
        {
        ...
        {
            var womenClothingCategory = _unitOfWork
                .ProductCategoryRepository
                .GetAsNoTracking(filter: c => c.CategoryID == (int)eProductCategories.Womens_Clothing);

            var customerProducts = _unitOfWork
               .ProductRepository
               .GetAllAsNoTracking(filter: p => p.CategoryID == womenClothingCategory!.CategoryID)?
               .Select(p => new
               {
                   ...
                   Category = womenClothingCategory
               })
             .Join(_unitOfWork
            ...
            var womenClothingProducts = customerProducts!
                .Join(_unitOfWork
