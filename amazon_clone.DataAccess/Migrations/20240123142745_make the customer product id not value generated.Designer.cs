...
namespace amazon_clone.DataAccess.Migrations
{
    ...
    [Migration("20240123142745_make the customer product id not value generated")]
    partial class makethecustomerproductidnotvaluegenerated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("amazon_clone.Models.Models.Payment", b =>
                {
            ...
            modelBuilder.Entity("amazon_clone.Models.Models.ClothingProduct", b =>
                {
            ...
            modelBuilder.Entity("amazon_clone.Models.Models.ClothesSizes", b =>
                {
                    b.HasOne("amazon_clone.Models.Models.ClothingProduct", "ClothesProduct")
            ...
            modelBuilder.Entity("amazon_clone.Models.Models.CustomerApplicationUser", b =>
                {
                    b.HasOne("amazon_clone.Models.Models.WishList", "WishList")
                        .WithOne("Customer")
                        .HasForeignKey("amazon_clone.Models.Models.CustomerApplicationUser", "WishListID");
            ...
            modelBuilder.Entity("amazon_clone.Models.Models.Payment", b =>
                {
                    ...
                    b.HasOne("amazon_clone.Models.Models.Order", "Order")
                        .WithOne("Payment")
                        .HasForeignKey("amazon_clone.Models.Models.Payment", "OrderID");
            ...
            modelBuilder.Entity("amazon_clone.Models.Models.ClothingProduct", b =>
                {
                    b.HasOne("amazon_clone.Models.Models.CustomerProduct", null)
                        .WithOne()
                        .HasForeignKey("amazon_clone.Models.Models.ClothingProduct", "ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
