...
namespace amazon_clone.Dashboard.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            RoleManager<AdministratorRole> roleManager)
        {
        ...
        {
            if (!_roleManager.RoleExistsAsync(StaticDetails.ROLE_ADMINISTRATOR).GetAwaiter().GetResult())
            {
                _roleManager.CreateAsync(new AdministratorRole(StaticDetails.ROLE_ADMINISTRATOR)).GetAwaiter().GetResult();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    await _userManager.AddToRoleAsync(user, StaticDetails.ROLE_ADMINISTRATOR);
